...
WorkoutHealthValue _$WorkoutHealthValueFromJson(Map<String, dynamic> json) =>
    WorkoutHealthValue(
      ...
      workoutPlan: json['workoutPlan'] as Map<String, dynamic>?,
      workoutEvents: (json['workoutEvents'] as List<dynamic>?),
      workoutActivities: (json['workoutActivities'] as List<dynamic>?),
    )..$type = json['__type'] as String?;
...
Map<String, dynamic> _$WorkoutHealthValueToJson(WorkoutHealthValue instance) =>
    <String, dynamic>{
      ...
      if (instance.workoutPlan case final value?) 'workoutPlan': value,
      if (instance.workoutEvents case final value?) 'workoutEvents': value,
      if (instance.workoutActivities case final value?)
        'workoutActivities': value,
    };
